...
async function updateVideo(event) {
  ...
  videoFileName = file.name; // Set the videoFileName property
  const fileNameWithoutExtension = videoFileName.split('.').slice(0, -1).join('.');
  
  // Instead, Save videoFileName to localStorage
  localStorage.setItem('videoFileName', fileNameWithoutExtension);
  //alert(videoFileName);
