...
export declare function makeMatMulPackedVec4Source(workPerThread: number[], workgroupSize: [number, number, number], transposeA?: boolean, tileInner?: number, splitK?: boolean, splitedDimInner?: number, isVectorA?: boolean, broadcastBatch?: boolean): string;
